  ...
  <div style="margin-top: 60px;">
    <div class="container" style="overflow-x:auto;">
      <div class="row">
        ...
        <div class="col-ms-3 col-sm-3 col-xs-3">
          <div class="search">
            <input @keypress="isNumber($event)" onkeypress="if(this.value.length == 10) return false;" v-model="phoneSeach" autocomplete="false" style="margin-top: 0px;" />
          </div>
        </div>
        <div class="col-ms-3 col-sm-3 col-xs-3"></div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-ms-1 col-sm-1 col-xs-1" style="margin-bottom: 5px;"><button class="button-re" v-on:click="getlistPhoneNumber()"><i class="fa fa-refresh" aria-hidden="true"></i></button></div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getlistPhoneNumber() {
      ...
      axios.get("https://key.my945capture.com/v2/api/parcel-capture/tasks/list/phone/number")
      .then(response => {
    ...
    filteredResourcesPhone() {
      if (this.phoneSeach) {
        return this.listPhone.filter(item => {
          ...
          return (!this.phoneSeach || phoneNumber.toLowerCase().includes(this.phoneSeach.toLowerCase()));
        });
      } else {
