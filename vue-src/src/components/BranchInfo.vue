<template>
    <div class="container" style="margin-top: 60px;">
        ...
        <div class="row">
            <div class="col-ms-2 col-sm-2 col-xs-2"><button class="button-add" v-on:click="addBranch(0)"><i class="fa fa-plus" aria-hidden="true"></i>เพิ่มข้อมูลสาขา</button></div>
      ...
      <table>
        <tr>
          ...
          <tr v-bind:key="item.id" v-for="item  in dataBranch">
            ...
            <button v-on:click="addBranch(item.branch_id)" class="button-set"><i class="fa fa-pencil" aria-hidden="true"></i></button>
          </td>
          </tr>
      </table>
