    ...
    <div class="container" style="overflow-x:auto;">
      ...
      <div class="row">
        ...
        <div class="controls" style="overflow-x:auto; width: 90%; margin:10px auto;">
          <div class="radio-inline" v-for="(item) in listModuleName" v-bind:key="item.id">
            <label>
              <input type="radio" style="margin-right: 0px;margin-left: 0px;width: 30px;" :value="item.moduleName" />
